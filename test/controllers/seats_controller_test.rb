...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference("Seat.count") do
      post seats_url, params: { seat: { cart_id: @seat.cart_id, column: @seat.column, cost: @seat.cost, row: @seat.row, state: @seat.state } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { cart_id: @seat.cart_id, column: @seat.column, cost: @seat.cost, row: @seat.row, state: @seat.state } }
